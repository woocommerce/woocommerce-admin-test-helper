...
export const Tasks = () => {
	...
	return (
		<>
			<h2>Tasks</h2>
			<p>
				This section contains tools for managing tasks in the task list.
			</p>
				...
				{editTaskNumber ? (
					<>
						...
						<Button
							isSecondary
							disabled={
								parseInt(taskNumber, 10) === taskNumberInput
							}
							onClick={updateTaskNumber}
						>
							Update
						</Button>
					</>
					...
					<>
						...
						<Button
							isPrimary
							onClick={() => setEditTaskNumber(true)}
						>
							Edit
						</Button>
					</>
