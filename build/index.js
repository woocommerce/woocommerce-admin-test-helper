...
function Options(_ref) {
  ...
  }, "Search products:"), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("input", {
    type: "search",
    name: "search"
...
/*!***********************************!*\
  !*** ./src/tools/data/actions.js ***!
  \***********************************/
/*! exports provided: addCurrentlyRunning, removeCurrentlyRunning, addMessage, updateMssage, removeMessage, triggerWcaInstall, resetOnboardingWizard, resetJetpackConnection, enableTrackingDebug, updateStoreAge, runWcAdminDailyJob */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateMssage", function() { return updateMssage; });
...
function updateMssage(source, message, status) {
  return {
    type: _action_types__WEBPACK_IMPORTED_MODULE_2__["default"].ADD_MESSAGE,
    source: source,
    message: message,
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return addCurrentlyRunning(id);

        case 3:
          _context.next = 5;
          return addMessage(id, 'Executing...');
        ...
        case 7:
          _context.next = 9;
          return removeCurrentlyRunning(id);

        case 9:
          _context.next = 11;
          return updateMssage(id, 'Successful!');
        ...
        case 13:
          ...
          _context.t0 = _context["catch"](0);
          _context.next = 17;
          return updateMssage(id, _context.t0.message, 'error');
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function enableTrackingDebug$(_context9) {
    while (1) {
      switch (_context9.prev = _context9.next) {
        case 0:
          _context9.next = 2;
          return runCommand('Enable WC Admin Tracking Deubg Mode', /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4() {
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function updateStoreAge$(_context11) {
    while (1) {
      switch (_context11.prev = _context11.next) {
        case 0:
          _context11.next = 2;
          return runCommand('Update Instllation timestamp', /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee5() {
              ...
              while (1) {
                switch (_context10.prev = _context10.next) {
                  case 0:
                    ...
                    numberOfDays = window.prompt('Please enter a date in mm/dd/yyy format', mm + '/' + dd + '/' + yyyy);
                    ...
                    newTimestamp = Math.round(new Date(dates[2], dates[0] - 1, dates[1]).getTime() / 1000);
                    payload = {
...
/* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./selectors */ "./src/tools/data/selectors.js");
/* harmony import */ var _reducer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./reducer */ "./src/tools/data/reducer.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./constants */ "./src/tools/data/constants.js");
/**
 * External dependencies
 */
...
/*!*************************************!*\
  !*** ./src/tools/data/selectors.js ***!
  \*************************************/
/*! exports provided: getCurrentlyRunning, getMessages, getStatus */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @wordpress/components */ "@wordpress/components");
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _commands__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./commands */ "./src/tools/commands.js");
...
function Tools(_ref) {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("tr", {
      ...
      className: "command"
    }, command.command), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("td", null, command.description), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("td", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__["Button"], {
      onClick: actions[command.action],
      disabled: currentlyRunningCommands[command.command],
      isPrimary: true
    }, "Run")));
  }))));
}
